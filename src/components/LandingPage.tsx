        ...
        <div className="container mx-auto text-center">
          ...
          <div className="mt-20 relative">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <Card className="animate-float bg-gradient-card border-0 shadow-lg" style={{ animationDelay: '0s' }}>
              ...
              <Card className="animate-float bg-gradient-card border-0 shadow-lg" style={{ animationDelay: '2s' }}>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-2">
              ...
              <Card className="animate-float bg-gradient-card border-0 shadow-lg" style={{ animationDelay: '4s' }}>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-2">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card 
                key={index}
                className={`p-6 text-center hover:shadow-lg transition-all duration-300 cursor-pointer bg-gradient-card border-0 ${
                  hoveredFeature === index ? 'scale-105 shadow-primary' : ''
                }`}
            ...
            {plans.map((plan, index) => (
              <Card 
                ...
                className={`relative p-8 ${
                  plan.popular 
                    ? 'border-primary shadow-xl scale-105 bg-gradient-card' 
